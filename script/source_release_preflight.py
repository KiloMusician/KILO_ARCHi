...
EXACT = RELEASE_FILES | ARC_REPLAY_FILES | {
    ...
    "docs/native-arc-capabilities.md", "docs/native-arc-solving.md", "docs/native-arc-workspace-integration.md", "docs/native-marketplace.md", "script/build_and_run.sh",
